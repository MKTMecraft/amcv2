namespace TodoDashboard.Common
{
    ...
    public class EmailHelper
    {
        ...
        public static string Send(string mailTo, string mailCC, string mailBCC, string subject, string body, List<byte[]> attachmentFile = null, List<string> attachmentName = null)
        {
            Boolean issent = true;
            ...
            try
            {
                if (!string.IsNullOrWhiteSpace(mailTo))
                {
                    ...
                    NetworkCred.UserName = "noreply.tododashboard@gmail.com";//jobsmy; //reading from web.config  
                    NetworkCred.Password = "*tT123123";//*jJ123123//"*lL123123"; //Configurations.EmailPassword; //reading from web.config                                       
                    objSMTP.Credentials = new System.Net.NetworkCredential(NetworkCred.UserName, NetworkCred.Password);
                    mailMesg.From = new System.Net.Mail.MailAddress("noreply.tododashboard@gmail.com");//new System.Net.Mail.MailAddress(mailFrom);
